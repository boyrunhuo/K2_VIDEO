                    ...
                    hbase.insertRecord({
                        ...
                        hbase.insertAllRecord({
                            ...
                            /*// 向标签索引表添加空标签记录
                             ...
                             console.log('................................. uploadHbase flag: ' + flag);
                ...
                hbase.insertAllRecord({
                    ...
                    if (err) {
                        ...
                        /*// 视频索引表添加记录
                         ...
                         var date = new Date();
                         var rowKeyValue = user + date.toLocaleString();
                         //var catalogueName = obj.video.substring(obj.video.indexOf('-')+1).substring(0,obj.video.indexOf('-', obj.video.indexOf('-')+1))+ '/' +
                         //  obj.video.substring(obj.video.indexOf('-')+1).substring(obj.video.indexOf('-', obj.video.indexOf('-')+1)+1);
                         var catalogueName = obj.video.substring(obj.video.indexOf('-')+1).replace('-','/');
                         console.log('........................./uploadHbase logRowKey: ' + rowKeyValue + ' catalogueName: ' + catalogueName);
                         hbase.insertAllRecord({
                         table: 'Table_VideoInteractionLog',
...
router.route('/deleteVideo').post(function(req, res){
    ...
    hbase.queryAllRecord({
        ...
        if(err) {
            ...
            console.log('....................../deleteVideo queryAllRecord Table_VideoIndex value: ' + JSON.stringify(value[0].$));
            sharedFilename = value[0].$;
            label = value[1].$;
            md5 = value[2].$;
